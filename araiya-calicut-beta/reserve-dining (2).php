...
if(isset($_POST['submit'])) {
	...
	$guest = $_POST['guest']; // not required
	 $Nature_of_Booking = $_POST['Nature_of_Booking']; // required 
...
<?php
  header('refresh:1;url=http://edibbee.com/projects/araiya-calicut/dining.html');
}
?>